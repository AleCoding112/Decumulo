...
| L'**ulteriore detrazione** 20.000–40.000 (1.000 €) e il **trattamento integrativo** (1.200 €) non sono modellati | il denominatore del decalage fra 32.000 e 40.000 letto sul testo: due fonti ne danno l'andamento, nessuna la formula | è **il buco più grosso rimasto**: sottostima il netto di ~690 € l'anno sull'esempio, e l'aliquota marginale effettiva di **12,5 punti** proprio nella fascia dove sta la maggior parte di chi usa il conto. `scadenze.mjs` rifiuta le cifre non confermate, quindi non si scrive finché non si legge |
